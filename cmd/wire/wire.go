...
func GetProvider() *dig.Container {
	...
	mustProvide(c, "statusReplyRepository", ProvideStatusReplyRepository)
	mustProvide(c, "userService", ProvideUserService)
	mustProvide(c, "mediaService", ProvideMediaService)
	mustProvide(c, "statusReplyService", ProvideStatusReplyService)
	...
	mustProvide(c, "downloadWorker", ProvideDownloadWorker)
